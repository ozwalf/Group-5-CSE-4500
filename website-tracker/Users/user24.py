...
def useActions(action, driver, rewardTime, reqList)->float:
    totalRewardTime = 0
...
def userAction(driver):
    ...
    tagNames = ["img"]
    link = ["a"]
    totalRewardTime += useActions("KEYWORD", driver, rewardTime, keywords)
    totalRewardTime += useActions("IMAGE", driver, rewardTime, tagNames)
    totalRewardTime += useActions("LINK", driver, rewardTime, link)
